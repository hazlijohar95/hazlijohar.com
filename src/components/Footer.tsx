  ...
  return <footer className="bg-black text-white text-center py-16 px-4 font-mono">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-3xl font-semibold mb-6">
          ...
          <sup className="inline-block bg-white text-black px-1.5 text-xs rounded align-super ml-1 mx-0 my-0 py-[7px]">NF1932</sup>
        </h1>
