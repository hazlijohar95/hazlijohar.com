...
const GetTicketsCTA = () => {
  ...
  return <section id="contact" className="bg-black py-16 sm:py-20 md:py-32 px-4 md:px-8 flex justify-center items-center">
      <div className="max-w-[720px] w-full relative overflow-hidden group">
        ...
        <Link to="/contact" className="bg-white text-black text-[28px] sm:text-[36px] md:text-[48px] lg:text-[64px] font-semibold tracking-tight px-6 py-4 sm:px-8 sm:py-6 md:px-16 md:py-8 w-full inline-flex items-center justify-between hover:scale-[1.03] transition-transform duration-300 ease-in-out mobile-tap-target" aria-label="Book a free call">
          Book A Free Call
        ...
        <div className="absolute -bottom-[10px] left-0 w-full h-[50px] overflow-hidden">
          <canvas ref={canvasRef} className="w-full h-full absolute bottom-0 left-0 opacity-80 transition-opacity duration-300 group-hover:opacity-100 mobile-optimize" aria-hidden="true" />
        </div>
      </div>
    </section>;
};
