  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation select-none active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        ghost:
          "hover:bg-accent hover:text-accent-foreground text-sm sm:text-base",
        link: "text-primary underline-offset-4 hover:underline text-sm sm:text-base",
        brand:
          "bg-white text-black hover:bg-gray-100 active:bg-gray-200 shadow-sm hover:shadow-md text-sm sm:text-base font-semibold",
        "outline-brand":
          "border-2 border-white text-white hover:bg-white/10 active:bg-white/20 text-sm sm:text-base font-medium",
        "ghost-brand":
          "text-white hover:bg-white/10 active:bg-white/20 text-sm sm:text-base font-medium",
      },
      size: {
        ...
        mobile:
          "min-h-[48px] px-6 py-3 text-base font-semibold w-full sm:w-auto", // Full-width mobile buttons
      },
    },
    defaultVariants: {
      variant: "default",
